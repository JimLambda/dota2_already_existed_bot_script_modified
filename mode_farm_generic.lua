...
local sNoticeList = {
	...
	[7] = "天地星AI交流群③: 244375519, 欢迎你的加入",
	[8] = "天地星AI交流群③: 244375519, 欢迎你的加入",
	[9] = "天地星AI交流群③: 244375519, 欢迎你的加入",
	[10] = "等√社度假回来, AI就会使用中立物品代币了",
	[11] = "赞助冠名或发送建议,请联系:dota2jmz@163.匚om",
...
function GetDesire()	
	...
	then
		...
		local firstMessage = "(AI游戏群:459875234)天地星AI: "..sPushVersion..sVersionDate		
		...
		then
			if bAllNotice
			then			
				bot:ActionImmediate_Chat("QQ交流群:244375519, 加群和其他玩家一起挑战多倍难度.",true);
